...
const entries: SitemapEntry[] = [
  ...
  { path: "/annuaire/", lastmod: "2026-09-16" },
  { path: "/incidents/", lastmod: "2026-09-16" },
  { path: "/a-propos/" },
  { path: "/contribuer/" },
  { path: "/agents/" },
  { path: "/methodologie/", lastmod: "2026-09-14" },
  { path: "/changements/", lastmod: "2026-09-16" },
  ...
  ...platforms.map((platform) => ({
    ...
    lastmod: ["2026-09-16", latestCheckedAt([platform, researchForPlatform(platform.slug), publicSiteObservationForPlatform(platform.slug)])].sort().at(-1),
  })),
